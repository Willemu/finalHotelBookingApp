...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Ultimate Hotels</a>
...
<div class="container">
  <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
    ...
    <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
      <img src="images/facilities/radio.png" width="80px">
    ...
    <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
      <img src="images/facilities/heat.png" width="80px">
  ...
  <div class="row">
    <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
      ...
      <div class="col-lg-4 col-md-4 p-4 rounded mb-4">
        <div class="bg-white">
          <h5>Call Us</h5>
          <a href="Tel: +27 111 2233" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i>+27 222 2233</a>
        </div>
        <div class="bg-white">
          <h5>Email Us</h5>
          <a href="email: hot@gmail.com" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-envelope-fill"></i>hot@gmail.com</a>
        </div>
      </div>
...
<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
          <h3 class="h-font fw-bold fs-3 mb-2">Ultimate Hotels</h3>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. At, tempora. Debitis architecto, itaque cumque nulla omnis unde deserunt similique ut dolore minus, accusantium eum eius ducimus aperiam reiciendis sunt neque.
          </p>
        </div>
        <div class="col-lg-4 p-4">
 ...
 <h6 class="text-center bg-dark text-white p-3 m-0">Designed by WH Uys</h6> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
            Note: Your details provided on arrival must match with you identification (ID Card, Passport, Drivers License) during check-in.
        </span>
        <div class="container-fluid">
           <div class="row">
